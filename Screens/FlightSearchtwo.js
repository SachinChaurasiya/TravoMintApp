              ...
              >
                ...
                >
                  ...
                  >
                    <View>
                      {/* <Text>15:40</Text> */}
                      <Text>{item.depDate.split('T')[1].substring(0, 5)}</Text>
                    </View>
                    <View>
                      <Text style={{ fontSize: 10 }}>{item.fromAirport}</Text>
                    </View>
                  </View>
                  <View
                  ...
                  >
                    ...
                    <View
                      style={{ height: 1, width: 60, backgroundColor: '#ccc' }}
                    />
                  </View>
                  <View
                    style={{
                  ...
                  >
                    ...
                    <View>
                      <Text style={{ fontSize: 10 }}>{item.toAirport}</Text>
                    </View>
                  </View>
                  <View>
                    {/* ₹-INR */}
