    ...
    return(
        ...
        <View>
            ...
            <TouchableOpacity onPress = {()=>alert('This is a btuuon')}>
               ...
               <View>
               <View style = {{backgroundColor:'white' , height:30, width:30, marginTop:10 ,marginLeft:8 , borderRadius:50, justifyContent:'center' , position:'absolute',zIndex:99 ,shadowRadius:10 ,shadowOpacity:4 , shadowColor:'grey',alignItems:'center'}}>
                   <Image 
