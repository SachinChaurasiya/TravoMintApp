        ...
        <View style={styles.container}>
          ...
          <View style={styles.mainList}>
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="receipt" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
            ...
            <View>
                <FontAwesome5 name="chevron-right" size={18} style={{paddingRight:20}} color="#ccc"/>
            </View>
            </View>
            <Separator/>
            <View style={styles.mainList}>
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="exchange-alt" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
            ...
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="user-tag" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
            ...
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="plane" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
                <View style={{paddingHorizontal:18}}>
            ...
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="headset" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
            ...
            <View style={{flexDirection: 'row',alignItems: 'center',paddingHorizontal:12}}>
                <View>
                    <FontAwesome5 name="user-cog" size={24} style={{paddingHorizontal:5}} color="#195fb9"/>
                </View>
                <View style={{paddingHorizontal:18}}>
