...
import { View , Text, FlatList , StyleSheet, ScrollView ,Dimensions , Modal,Image ,  Alert , TouchableOpacity } from "react-native"
           ...
           /></Text>
            ...
            setActiveTab={setActiveTab}/></Text>
                ...
                <View>                
                         <View> 
                      {isVisible? (
              <Animatable.View animation="lightSpeedIn" style={{flexDirection:'row' ,justifyContent:'space-around'}}>
...
<FlatList
      ...
      >
        ...
        <View style={styles.centeredView}>
          ...
          <View style={[styles.modalView,{marginTop:240}]}>
...
//     }
    ...
    return(
        ...
        <View style={styles.header}>
          <View style={{position:"absolute",left:50,top:30,alignItems: 'center',justifyContent: 'center'}}>
            <View><Text style={{color:COLOR.white,fontSize:15,fontWeight:'bold'}}>Go TO</Text></View>
            <View style={{
                        width: 60,
                        height: 3,
          ...
          <View style={{flexDirection: 'row',alignItems: 'center',}}>
            <View style={{}}>
            <Text style={{color:COLOR.white,fontSize:20,fontWeight:'bold'}}>DEL</Text>
            </View>
            <View style={{paddingHorizontal:5}}>
              <Text style={{color:COLOR.white,fontSize:20,fontWeight:'bold'}}>-</Text>
            </View>
            <View>
              <Text style={{color:COLOR.white,fontSize:20,fontWeight:'bold'}}>GOI</Text>
            </View>
          </View>
          <View>
            <Text style={{color:COLOR.white,fontSize:16,fontWeight:'bold'}}>2h:10m</Text>
          </View>
          <View>
            <Text style={{color:COLOR.white,fontSize:30,fontWeight:'bold'}}>₹950.72</Text>
          </View>
          </View>
          {/* icon */}
          ...
          {/* return */}
          <View style={{position:"absolute",right:50,top:30,alignItems: 'center'}}>
          <View><Text style={{color:COLOR.white,fontSize:15,fontWeight:'bold'}}>Return</Text></View>
            <View style={{
                        width: 60,
                        height: 3,
                        backgroundColor: COLOR.secondary,}}/>
          ...
          <View>
            <Text  style={{color:COLOR.white,fontSize:16,fontWeight:'bold'}}>2h:45m</Text>
          </View>
          <View>
            <Text style={{color:COLOR.white,fontSize:30,fontWeight:'bold'}}> ₹950.72</Text>
          </View>
